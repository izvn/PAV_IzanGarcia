...
class BreakoutPauseScene : public Scene
{
private:
...
public:
    BreakoutPauseScene() = default;
    ~BreakoutPauseScene() override = default;
    ...
    void Update() override
    {
        ...
        {
            BreakoutGameplay* g = dynamic_cast<BreakoutGameplay*>(SM.GetScene("Breakout"));
            if (g) g->ForceCleanup();
