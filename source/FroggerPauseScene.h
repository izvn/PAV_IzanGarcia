...
class FroggerPauseScene : public Scene
{
private:
...
public:
    FroggerPauseScene() = default;
    ~FroggerPauseScene() override = default;
    ...
    void Update() override
    {
        ...
        {
            FroggerGameplay* g = dynamic_cast<FroggerGameplay*>(SM.GetScene("Frogger"));
            if (g) g->ForceCleanup();
