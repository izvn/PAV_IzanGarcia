...
class CentipedePauseScene : public Scene
{
private:
...
public:
    CentipedePauseScene() = default;
    ~CentipedePauseScene() override = default;
    ...
    void Update() override
    {
        ...
        {
            CentipedeGameplay* g = dynamic_cast<CentipedeGameplay*>(SM.GetScene("Centipede"));
            if (g) g->ForceCleanup();
