...
class ArenaPauseScene : public Scene
{
private:
...
public:
    ArenaPauseScene() = default;
    ~ArenaPauseScene() override = default;
    ...
    void Update() override
    {
        ...
        {
            ArenaGameplay* g = dynamic_cast<ArenaGameplay*>(SM.GetScene("Arena"));
            if (g) g->ForceCleanup();
