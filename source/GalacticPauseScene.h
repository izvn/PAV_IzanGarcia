...
class GalacticPauseScene : public Scene
{
private:
...
public:
    GalacticPauseScene() = default;
    ~GalacticPauseScene() override = default;
    ...
    void Update() override
    {
        ...
        {
            GalacticGameplay* g = dynamic_cast<GalacticGameplay*>(SM.GetScene("Galactic"));
            if (g) g->ForceCleanup();
