...
class ScrollerPauseScene : public Scene
{
private:
...
public:
    ScrollerPauseScene() = default;
    ~ScrollerPauseScene() override = default;
    ...
    void Update() override
    {
        ...
        {
            ScrollerGameplay* g = dynamic_cast<ScrollerGameplay*>(SM.GetScene("Scroller"));
            if (g) g->ForceCleanup();
